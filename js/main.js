...
const sendEmail = (e) =>{
    ...
    if(contactName.value === '' || contactNumber.value === '' || contactEmail.value === '' || contactQuery.value === ''){
...
const scrollHeader = () => {
    ...
    // When the scroll is greater than 50 view point height, add the scroll - header class to the header tag
...
const typed = new Typed('.multiple-text',{
    strings: ['Frontend Developer', 'System Administrator', 'Senior LMS Engineer'],
    typedSpeed: 150,
    backSpeed: 150,
    backDelay: 1500,
    loop: true
